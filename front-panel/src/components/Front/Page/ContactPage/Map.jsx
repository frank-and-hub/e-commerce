...
class Map extends Component {
    componentDidMount() {
        ...
        L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
            maxZoom: 18,
            attribution: 'Zay Telmplte | Template Design by <a to="https://templatemo.com/">Templatemo</a> | Map data &copy; <a to="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
                '<a to="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, ' +
                'Imagery © <a to="https://www.mapbox.com/">Mapbox</a>',
