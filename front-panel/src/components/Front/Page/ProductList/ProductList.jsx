                        ...
                        <div className={`col-lg-9`}>
                            ...
                            <div className={`row`}>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_02.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_03.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_04.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_05.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_06.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_07.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_08.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
                                ...
                                <div className={`col-md-4`}>
                                    <div className={`card mb-4 product-wap rounded-0`}>
                                        <div className={`card rounded-0`}>
                                            <img className={`card-img rounded-0 img-fluid`} src={`assets/img/shop_09.jpg`} alt={`#`} />
                                                <div className={`card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center`}>
                                                    <ul className={`list-unstyled`}>
                                                        <li><Link className={`btn btn-success text-white`} to={`product`}><i className={`far fa-heart`}></i></Link></li>
                                                        <li><Link className={`btn btn-success text-white mt-2`} to={`product`}><i className={`far fa-eye`}></i></Link></li>
